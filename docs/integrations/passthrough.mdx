...
- A pool-account symptom (401, 402, 403, 429) retries the same provider on a different key
  from its pool and never escalates — a bad credential or a rate limit is not a reason to pay
